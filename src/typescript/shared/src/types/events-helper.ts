...
export const DestinationTopics: Record<number, string> = {
  ...
  [Destination.DESTINATION_GITHUB]: 'topic-job-upload-github',
};
...
// NOTE: parseDestination is now generated by generate-enum-formatters.ts
// and exported from './pb/enum-formatters'. Re-exported here for lint compliance (T11).
export { parseDestination } from './pb/enum-formatters';
