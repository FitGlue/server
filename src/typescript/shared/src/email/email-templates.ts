 ...
 */
function renderLayout({ content, previewText }: EmailLayoutOptions): string {
    return `<!DOCTYPE html>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                  <td style="text-align:center;padding-bottom:12px;">
                    <a href="${BASE_URL}" style="color:${BRAND.textMuted};font-size:12px;text-decoration:none;margin:0 8px;">Website</a>
...
export function welcomeTemplate(): string {
    const dashboardUrl = `${BASE_URL}/app`;
    return renderLayout({
 ...
 */
export function dataExportTemplate(downloadUrl: string): string {
    return renderLayout({
 ...
 */
export function changeEmailTemplate(verificationUrl: string, newEmail: string): string {
    return renderLayout({
 ...
 */
export function trialExpiringTemplate(daysLeft: number): string {
    const upgradeUrl = `${BASE_URL}/app/subscription`;
    return renderLayout({
 ...
 */
export function trialExpiredTemplate(): string {
    const upgradeUrl = `${BASE_URL}/app/subscription`;
    return renderLayout({
