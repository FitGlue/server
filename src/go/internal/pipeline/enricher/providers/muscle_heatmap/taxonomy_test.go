...
func TestLookupExercise_ExactMatch(t *testing.T) {
	tests := []struct {
		...
		input    string
		wantName string
		wantPrim pbactivity.MuscleGroup
	}{
		{
			name:     "exact canonical name",
			input:    "Bench Press",
			wantName: "Bench Press",
			wantPrim: pbactivity.MuscleGroup_MUSCLE_GROUP_CHEST,
		},
		{
			name:     "exact canonical name - squat",
			input:    "Squat",
			wantName: "Squat",
			wantPrim: pbactivity.MuscleGroup_MUSCLE_GROUP_QUADRICEPS,
		},
		{
			name:     "exact canonical name - deadlift",
			input:    "Deadlift",
			wantName: "Deadlift",
			wantPrim: pbactivity.MuscleGroup_MUSCLE_GROUP_LOWER_BACK,
		},
		{
			name:     "exact canonical name - bicep curl",
			input:    "Bicep Curl",
			wantName: "Bicep Curl",
			wantPrim: pbactivity.MuscleGroup_MUSCLE_GROUP_BICEPS,
		},
		{
			name:     "exact canonical name - pull up",
			input:    "Pull Up",
			wantName: "Pull Up",
			wantPrim: pbactivity.MuscleGroup_MUSCLE_GROUP_LATS,
		},
	}
...
func TestLookupExercise_AliasMatch(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			wantPrim: pbactivity.MuscleGroup_MUSCLE_GROUP_SHOULDERS,
		},
		{
			name:     "OHP alias",
			input:    "OHP",
		...
		},
		{
			...
			wantPrim: pbactivity.MuscleGroup_MUSCLE_GROUP_HAMSTRINGS,
		},
		{
			name:     "farmers walk with apostrophe",
			input:    "Farmer's Walk",
			wantName: "Farmers Walk",
			wantPrim: pbactivity.MuscleGroup_MUSCLE_GROUP_FULL_BODY,
		},
	}
...
func TestLookupExercise_NoMatch(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if result.Primary != pbactivity.MuscleGroup_MUSCLE_GROUP_OTHER {
...
func TestLookupExercise_HexyExerciseNames(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			wantPrim: pbactivity.MuscleGroup_MUSCLE_GROUP_CARDIO,
		},
		{
			name:     "Hevy wall sit",
			input:    "Wall Sit",
		...
		},
		{
			...
			wantName: "Bent Over Row",
			wantPrim: pbactivity.MuscleGroup_MUSCLE_GROUP_UPPER_BACK,
		},
		{
			name:     "Hevy snatch",
			input:    "Snatch",
		...
		},
		{
			...
			input:    "Crunch",
			wantName: "Crunch",
			wantPrim: pbactivity.MuscleGroup_MUSCLE_GROUP_ABDOMINALS,
		},
		{
...
func TestLookupExercise_SecondaryMuscles(t *testing.T) {
	tests := []struct {
		name          string
		input         string
		wantSecondary []pbactivity.MuscleGroup
	}{
		{
			name:          "bench press has triceps and shoulders secondary",
			input:         "Bench Press",
			wantSecondary: []pbactivity.MuscleGroup{pbactivity.MuscleGroup_MUSCLE_GROUP_TRICEPS, pbactivity.MuscleGroup_MUSCLE_GROUP_SHOULDERS},
		},
		{
			name:          "squat has glutes and hamstrings secondary",
			input:         "Squat",
			wantSecondary: []pbactivity.MuscleGroup{pbactivity.MuscleGroup_MUSCLE_GROUP_GLUTES, pbactivity.MuscleGroup_MUSCLE_GROUP_HAMSTRINGS},
		},
		{
