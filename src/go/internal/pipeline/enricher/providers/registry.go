...
var (
	...
	typeRegistry = make(map[pbplugin.EnricherProviderType]Provider)
)
...
func Register(p Provider) {
	...
	t := p.ProviderType()
	if t != pbplugin.EnricherProviderType_ENRICHER_PROVIDER_UNSPECIFIED {
...
func GetByType(t pbplugin.EnricherProviderType) (Provider, bool) {
	registryMu.RLock()
	defer registryMu.RUnlock()
