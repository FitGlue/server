...
func (p *LogicGateProvider) ProviderType() pbplugin.EnricherProviderType {
	return pbplugin.EnricherProviderType_ENRICHER_PROVIDER_LOGIC_GATE
}
...
func (p *LogicGateProvider) Enrich(ctx context.Context, logger *slog.Logger, act *pbactivity.StandardizedActivity, user *user.Record, inputs map[string]string, doNotRetry bool) (*providers.EnrichmentResult, error) {
...
func evaluateRule(r Rule, act *pbactivity.StandardizedActivity) (bool, error) {
...
func getStartLocation(act *pbactivity.StandardizedActivity) (lat, lng float64, ok bool) {
