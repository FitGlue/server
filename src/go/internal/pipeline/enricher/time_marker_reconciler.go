...
func reconcileTimeMarkerLabels(activity *pbactivity.StandardizedActivity) {
...
func reconcileByPosition(markers []*pbactivity.TimeMarker, sets []*pbactivity.StrengthSet) {
...
func reconcileByTimestamp(markers []*pbactivity.TimeMarker, sets []*pbactivity.StrengthSet) {
