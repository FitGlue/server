...
type ExecutionRecord struct {
	...
	Timestamp   *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=timestamp,proto3" json:"timestamp,omitempty"`                         // Required: when it started
	...
	ExpireAt     *timestamppb.Timestamp `protobuf:"bytes,14,opt,name=expire_at,json=expireAt,proto3,oneof" json:"expire_at,omitempty"`          // When this record should be deleted
