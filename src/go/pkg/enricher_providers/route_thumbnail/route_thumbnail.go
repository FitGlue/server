...
func init() {
	enricher_providers.Register(NewRouteThumbnailProvider())
}
...
func (p *RouteThumbnailProvider) Enrich(ctx context.Context, activity *pb.StandardizedActivity, user *pb.UserRecord, inputConfig map[string]string, doNotRetry bool) (*enricher_providers.EnrichmentResult, error) {
