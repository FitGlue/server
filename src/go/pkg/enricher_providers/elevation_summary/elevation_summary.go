...
func init() {
	enricher_providers.Register(NewElevationSummary())
}
...
func (p *ElevationSummary) Enrich(ctx context.Context, activity *pb.StandardizedActivity, user *pb.UserRecord, inputs map[string]string, doNotRetry bool) (*enricher_providers.EnrichmentResult, error) {
	var gain float64
	var loss float64
