...
func init() {
	enricher_providers.Register(NewPowerSummary())
}
...
func (p *PowerSummary) Enrich(ctx context.Context, activity *pb.StandardizedActivity, user *pb.UserRecord, inputs map[string]string, doNotRetry bool) (*enricher_providers.EnrichmentResult, error) {
