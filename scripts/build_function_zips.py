...
def main():
    ...
    for function_name in ["router", "enricher", "strava-uploader", "mock-uploader", "parkrun-results-source", "showcase-uploader", "fit-parser-handler", "hevy-uploader", "trainingpeaks-uploader"]:
